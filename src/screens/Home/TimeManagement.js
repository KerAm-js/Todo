...
const technics = [
  ...
  },
  {
    id: 1,
    name: '90 на 30',
    content: 'Суть заключается в следующем: 90 минут вы работаете, а 30 минут - отдыхаете. Техника подойдёт, если вы занимаетесь монотонной работой. А если у вас много разных задач, можно разбить их на подзадачи и определить время для них. Например, с 8:00 до 9:30 вы выполняете одну из подзадач, а с 9:30 до 10:00 - у вас отдых.'
  },
  {
    id: 2,
    name: '25 на 5',
