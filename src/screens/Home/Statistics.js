            ...
            <Text style={styles.title}>Как работает статистика?</Text>
            {
              howStatsWorksVisible
                ? <>
                    ...
                    <Text style={styles.description}>
                      {`2) Выполнено в срок.\nПоказывает долю задач, выполненных вовремя, от всех задач. Если вы добавляете к задаче временной интервал, то это и будет сроком её выполнения. А иначе, программа будет считать сроком выполнения весь текущий день.`}
                    </Text>
                    <Text style={styles.description}>
                      {`3) Задач выполнено.\nПоказывает долю выполненных задач от всех задач. Если показатель равен, например, 50%, это значит, что из всех задач, когда-либо записанных вами в приложении, вы выполнили половину.`}
                    </Text>
                    <Text style={styles.description}>
